...
//Double_t Ymax_max = 5.0;
 ...
 Double_t Ymin_min = 1.0;
 Double_t Ymin_max = 1.95;
 
 Double_t Ymax_min = 1.0;
 Double_t Ymax_max = 1.95;


void fitMass_new_1x1_v1()
{
    SetReader();
    PlotSignificance();
    fit();
...
void fit()
{
    ...
    //RooFitResult *fitmasY2 = MassModelY2.fitTo(*dataYmax, Save(kTRUE), Strategy(1), NumCPU(2));
